# -*- coding: utf-8 -*-
"""
Created on Thu Sep 27 13:17:37 2018
...
def read_u_ECMWF(year_array):
    ...
    directoryname='E:/datasets/JRA55/'  
    variable_name='JRA55_u10'
...
for period in range(3):
    if period == 0:
        year_array=np.arange(1958,1979+1) # identify time period for analysis
    elif period == 1:
