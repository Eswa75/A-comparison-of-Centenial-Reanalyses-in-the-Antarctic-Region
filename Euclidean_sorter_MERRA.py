# -*- coding: utf-8 -*-
"""
Created on Thu Sep 27 13:17:38 2018
...
def read_u_ECMWF(year_array):
    ...
    directoryname='E:/datasets/MERRA2/MERRA2_UVmslpT/'  
    variable_name='U2M'
    ...
    climatology = ncid1.U2M.groupby('time.dayofyear').mean('time')
    # calculate the anomaly from the 20 year climatology
    anomalies = ncid1.U2M.groupby('time.dayofyear') - climatology
...
def read_v_ECMWF(year_array):
    ...
    # calculate day of year climatology 
    climatology = ncid1.V2M.groupby('time.dayofyear').mean('time')
    # calculate the anomaly from the 20 year climatology
    anomalies = ncid1.V2M.groupby('time.dayofyear') - climatology
 # output the raw xarray (ncid1) and anomaly patterns and the climatology
    return anomalies,climatology,ncid1
